...
type Person = { jobData :: JobData, addresses :: Array Address }
...
validateSalary = case _ of
  n | n > 150000.0 -> valid (Salary n)
  n -> invalid (FieldInvalid $ "Salary of " <> show n <> " is too low")

validateZip :: Validate String Zip
validateZip n = case fromString n of
  Just zip
    | 10000 <= zip && zip <= 99999 -> valid (Zip zip)
  Just _ -> invalid (FieldInvalid $ "Zip " <> n <> " out of range")
